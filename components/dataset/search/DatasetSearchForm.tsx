  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="flex min-h-[76px] flex-col gap-3 ]  lg:flex-row lg:items-center">
        ...
        <button
          className="inline-flex items-center justify-center rounded-full bg-[var(--brand-green)] px-8 py-4 text-[13px] font-bold uppercase tracking-[0.22em] text-[var(--interactive-hover-text)] transition hover:bg-[var(--dark)] hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--brand-green)] focus-visible:ring-offset-2"
          type="submit"
        >
          SEARCH
        </button>
